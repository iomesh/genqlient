...
[![Go Reference](https://pkg.go.dev/badge/github.com/iomesh/genqlient.svg)](https://pkg.go.dev/github.com/iomesh/genqlient)
[![Test Status](https://github.com/iomesh/genqlient/actions/workflows/go.yml/badge.svg)](https://github.com/iomesh/genqlient/actions)
[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](docs/CODE_OF_CONDUCT.md)
[![GoReportcard](https://goreportcard.com/badge/github.com/iomesh/genqlient?status.svg)](https://goreportcard.com/report/github.com/iomesh/genqlient)
...
You can download and run genqlient the usual way: `go run github.com/iomesh/genqlient`.  To set your project up to use genqlient, see the [getting started guide](docs/INTRODUCTION.md), or the [example](example).  For more complete documentation, see the [docs](docs).
